...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__20040){
var map__20041 = p__20040;
var map__20041__$1 = (((((!((map__20041 == null))))?(((((map__20041.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20041.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20041):map__20041);
var handler = cljs.core.get.call(null,map__20041__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__4047__auto__ = p1__20043_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__20044){
...
var request = map__20045__$1;
var interceptors = cljs.core.get.call(null,map__20045__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
