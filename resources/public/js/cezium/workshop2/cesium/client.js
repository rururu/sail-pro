...
var map__5239 = view;
var map__5239__$1 = (((((!((map__5239 == null))))?(((((map__5239.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__5239.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__5239):map__5239);
var longitude = cljs.core.get.call(null,map__5239__$1,new cljs.core.Keyword(null,"longitude","longitude",-1268876372));
var latitude = cljs.core.get.call(null,map__5239__$1,new cljs.core.Keyword(null,"latitude","latitude",394867543));
var height = cljs.core.get.call(null,map__5239__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var heading = cljs.core.get.call(null,map__5239__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var pitch = cljs.core.get.call(null,map__5239__$1,new cljs.core.Keyword(null,"pitch","pitch",1495126700));
var roll = cljs.core.get.call(null,map__5239__$1,new cljs.core.Keyword(null,"roll","roll",11266999));
...
cesium.client.VIEWER.homeButton.viewModel.command.beforeExecute.addEventListener(((function (map__5239,map__5239__$1,longitude,latitude,height,heading,pitch,roll,fvw){
return (function (e){
e.cancel = true;

return camera.flyTo(cesium.client.HOME_VIEW);
});})(map__5239,map__5239__$1,longitude,latitude,height,heading,pitch,roll,fvw))
);

return camera.flyTo(cesium.client.HOME_VIEW);
});
cesium.client.clock_settings = (function cesium$client$clock_settings(var_args){
var G__5242 = arguments.length;
switch (G__5242) {
case 3:
...
var map__5243 = settings;
var map__5243__$1 = (((((!((map__5243 == null))))?(((((map__5243.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__5243.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__5243):map__5243);
var animate = cljs.core.get.call(null,map__5243__$1,new cljs.core.Keyword(null,"animate","animate",1850194573));
var start = cljs.core.get.call(null,map__5243__$1,new cljs.core.Keyword(null,"start","start",-355208981));
var stop = cljs.core.get.call(null,map__5243__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
var current = cljs.core.get.call(null,map__5243__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var mult = cljs.core.get.call(null,map__5243__$1,new cljs.core.Keyword(null,"mult","mult",1466794774));
var step = cljs.core.get.call(null,map__5243__$1,new cljs.core.Keyword(null,"step","step",1288888124));
var range = cljs.core.get.call(null,map__5243__$1,new cljs.core.Keyword(null,"range","range",1639692286));
...
clock.clockStep = (function (){var pred__5245 = cljs.core._EQ_;
var expr__5246 = step;
if(cljs.core.truth_(pred__5245.call(null,"TICK_DEPENDENT",expr__5246))){
return Cesium.ClockStep.TICK_DEPENDENT;
} else {
if(cljs.core.truth_(pred__5245.call(null,"SYSTEM_CLOCK_MULTIPLIER",expr__5246))){
return Cesium.ClockStep.SYSTEM_CLOCK_MULTIPLIER;
} else {
if(cljs.core.truth_(pred__5245.call(null,"SYSTEM_CLOCK",expr__5246))){
...
clock.clockRange = (function (){var pred__5248 = cljs.core._EQ_;
var expr__5249 = range;
if(cljs.core.truth_(pred__5248.call(null,"UNBOUNDED",expr__5249))){
return Cesium.ClockRange.UNBOUNDED;
} else {
if(cljs.core.truth_(pred__5248.call(null,"CLAMPED",expr__5249))){
return Cesium.ClockRange.CLAMPED;
} else {
if(cljs.core.truth_(pred__5248.call(null,"LOOP_STOP",expr__5249))){
return Cesium.ClockRange.LOOP_STOP;
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__5249)].join('')));
}
}
}
})();
...
var promise = (function (){var pred__5252 = cljs.core._EQ_;
var expr__5253 = format;
if(cljs.core.truth_(pred__5252.call(null,new cljs.core.Keyword(null,"GeoJSON","GeoJSON",33508860),expr__5253))){
return Cesium.GeoJsonDataSource.load(source,options);
} else {
if(cljs.core.truth_(pred__5252.call(null,new cljs.core.Keyword(null,"CZML","CZML",-1539311408),expr__5253))){
return Cesium.CzmlDataSource.load(source,options);
} else {
if(cljs.core.truth_(pred__5252.call(null,new cljs.core.Keyword(null,"KML","KML",1829561453),expr__5253))){
return Cesium.KmlDataSource.load(source,options);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__5253)].join('')));
}
}
}
})();
...
cesium.client.azimuths_AMPERSAND_points = (function cesium$client$azimuths_AMPERSAND_points(p__5256,radr,hgt,N){
var vec__5257 = p__5256;
var c_lambda = cljs.core.nth.call(null,vec__5257,(0),null);
var c_phi = cljs.core.nth.call(null,vec__5257,(1),null);
var s = ((Math.PI * (2)) / N);
var azs = cljs.core.range.call(null,(0),(N * s),s);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [azs,cljs.core.vec.call(null,cljs.core.map.call(null,((function (s,azs,vec__5257,c_lambda,c_phi){
return (function (p1__5255_SHARP_){
return cljs.core.concat.call(null,cesium.client.position_js.call(null,c_lambda,c_phi,radr,p1__5255_SHARP_),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [hgt], null));
});})(s,azs,vec__5257,c_lambda,c_phi))
,azs))], null);
});
...
var vec__5260 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cmp__$1.longitude,cmp__$1.latitude,cmp__$1.height], null);
var lam = cljs.core.nth.call(null,vec__5260,(0),null);
var phi = cljs.core.nth.call(null,vec__5260,(1),null);
var hgt = cljs.core.nth.call(null,vec__5260,(2),null);
var az = camera.heading;
var c = ((((dist_m / (1852)) / (60)) / (180)) * Math.PI);
var vec__5263 = cesium.client.position_js.call(null,lam,phi,c,az);
var lam2 = cljs.core.nth.call(null,vec__5263,(0),null);
var phi2 = cljs.core.nth.call(null,vec__5263,(1),null);
...
return (function (){
var pred__5269 = cljs.core._EQ_;
var expr__5270 = cljs.core.deref.call(null,cesium.client.ORBIT).call(null,new cljs.core.Keyword(null,"status","status",-1997798413));
if(cljs.core.truth_(pred__5269.call(null,new cljs.core.Keyword(null,"init","init",-1875481434),expr__5270))){
...
if(cljs.core.truth_(pred__5269.call(null,new cljs.core.Keyword(null,"stop","stop",-2140911342),expr__5270))){
...
var vec__5272 = cesium.client.look_at.call(null,camera,radm);
var lam = cljs.core.nth.call(null,vec__5272,(0),null);
var phi = cljs.core.nth.call(null,vec__5272,(1),null);
var hgt = cljs.core.nth.call(null,vec__5272,(2),null);
var look = vec__5272;
var vec__5275 = cesium.client.azimuths_AMPERSAND_points.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [lam,phi], null),radr,hgt,steps);
var azs = cljs.core.nth.call(null,vec__5275,(0),null);
var pts = cljs.core.nth.call(null,vec__5275,(1),null);
var ring = cljs.core.vec.call(null,cljs.core.map.call(null,((function (steps,radm,radr,vec__5272,lam,phi,hgt,look,vec__5275,azs,pts,pred__5269,expr__5270,obut){
return (function (p1__5267_SHARP_){
return Cesium.Cartesian3.fromRadians(cljs.core.first.call(null,p1__5267_SHARP_),cljs.core.second.call(null,p1__5267_SHARP_),cljs.core.nth.call(null,p1__5267_SHARP_,(2)));
});})(steps,radm,radr,vec__5272,lam,phi,hgt,look,vec__5275,azs,pts,pred__5269,expr__5270,obut))
,pts));
var headings = cljs.core.vec.call(null,cljs.core.map.call(null,((function (steps,radm,radr,vec__5272,lam,phi,hgt,look,vec__5275,azs,pts,ring,pred__5269,expr__5270,obut){
return (function (p1__5268_SHARP_){
return cesium.client.normaz.call(null,(p1__5268_SHARP_ + Math.PI));
});})(steps,radm,radr,vec__5272,lam,phi,hgt,look,vec__5275,azs,pts,ring,pred__5269,expr__5270,obut))
,azs));
...
if(cljs.core.truth_(pred__5269.call(null,new cljs.core.Keyword(null,"run","run",-1821166653),expr__5270))){
camera.cancelFlight();

return cljs.core._vreset_BANG_.call(null,cesium.client.ORBIT,cljs.core.assoc.call(null,cljs.core._deref.call(null,cesium.client.ORBIT),new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"stop","stop",-2140911342)));
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__5270)].join('')));
}
}
}
});})(obut))
