...
return Cesium.defined(p1__12001_SHARP_.billboard);
});})(vals))
,vals);
var seq__12002 = cljs.core.seq.call(null,ebbs);
var chunk__12003 = null;
var count__12004 = (0);
var i__12005 = (0);
while(true){
if((i__12005 < count__12004)){
var ebb = cljs.core._nth.call(null,chunk__12003,i__12005);
...
var pos_12006 = ebb.position.getValue(Cesium.JulianDate.now());
var pos_12007__$1 = Cesium.Cartographic.fromCartesian(pos_12006);
var lat_12008 = Cesium.Math.toDegrees(pos_12007__$1.latitude);
var lon_12009 = Cesium.Math.toDegrees(pos_12007__$1.longitude);
var desc_12010 = ["<table class=\"cesium-infoBox-defaultTable cesium-infoBox-defaultTable-lighter\"><tbody>","<tr><th>Longitude</th><td>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(lon_12009.toFixed((5))),"</td></tr>","<tr><th>Latitude</th><td>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(lat_12008.toFixed((5))),"</td></tr>","</tbody></table>"].join('');
ebb.description = desc_12010;


var G__12011 = seq__12002;
var G__12012 = chunk__12003;
var G__12013 = count__12004;
var G__12014 = (i__12005 + (1));
seq__12002 = G__12011;
chunk__12003 = G__12012;
count__12004 = G__12013;
i__12005 = G__12014;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq.call(null,seq__12002);
if(temp__5735__auto__){
var seq__12002__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__12002__$1)){
var c__4461__auto__ = cljs.core.chunk_first.call(null,seq__12002__$1);
var G__12015 = cljs.core.chunk_rest.call(null,seq__12002__$1);
var G__12016 = c__4461__auto__;
var G__12017 = cljs.core.count.call(null,c__4461__auto__);
var G__12018 = (0);
seq__12002 = G__12015;
chunk__12003 = G__12016;
count__12004 = G__12017;
i__12005 = G__12018;
continue;
} else {
var ebb = cljs.core.first.call(null,seq__12002__$1);
ebb.billboard.verticalOrigin = Cesium.VerticalOrigin.BOTTOM;
...
var pos_12019 = ebb.position.getValue(Cesium.JulianDate.now());
var pos_12020__$1 = Cesium.Cartographic.fromCartesian(pos_12019);
var lat_12021 = Cesium.Math.toDegrees(pos_12020__$1.latitude);
var lon_12022 = Cesium.Math.toDegrees(pos_12020__$1.longitude);
var desc_12023 = ["<table class=\"cesium-infoBox-defaultTable cesium-infoBox-defaultTable-lighter\"><tbody>","<tr><th>Longitude</th><td>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(lon_12022.toFixed((5))),"</td></tr>","<tr><th>Latitude</th><td>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(lat_12021.toFixed((5))),"</td></tr>","</tbody></table>"].join('');
ebb.description = desc_12023;


var G__12024 = cljs.core.next.call(null,seq__12002__$1);
var G__12025 = null;
var G__12026 = (0);
var G__12027 = (0);
seq__12002 = G__12024;
chunk__12003 = G__12025;
count__12004 = G__12026;
i__12005 = G__12027;
continue;
}
} else {
...
return Cesium.defined(p1__12028_SHARP_.polygon);
});})(vals))
,vals);
var seq__12029 = cljs.core.seq.call(null,epls);
var chunk__12030 = null;
var count__12031 = (0);
var i__12032 = (0);
while(true){
if((i__12032 < count__12031)){
var epl = cljs.core._nth.call(null,chunk__12030,i__12032);
...
var poss_12033 = epl.polygon.hierarchy.getValue(Cesium.JulianDate.now()).positions;
var cntr_12034 = Cesium.BoundingSphere.fromPoints(poss_12033).center;
var cntr_12035__$1 = Cesium.Ellipsoid.WGS84.scaleToGeodeticSurface(cntr_12034);
epl.position = cntr_12035__$1;
...
var G__12036 = seq__12029;
var G__12037 = chunk__12030;
var G__12038 = count__12031;
var G__12039 = (i__12032 + (1));
seq__12029 = G__12036;
chunk__12030 = G__12037;
count__12031 = G__12038;
i__12032 = G__12039;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq.call(null,seq__12029);
if(temp__5735__auto__){
var seq__12029__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__12029__$1)){
var c__4461__auto__ = cljs.core.chunk_first.call(null,seq__12029__$1);
var G__12040 = cljs.core.chunk_rest.call(null,seq__12029__$1);
var G__12041 = c__4461__auto__;
var G__12042 = cljs.core.count.call(null,c__4461__auto__);
var G__12043 = (0);
seq__12029 = G__12040;
chunk__12030 = G__12041;
count__12031 = G__12042;
i__12032 = G__12043;
continue;
} else {
var epl = cljs.core.first.call(null,seq__12029__$1);
epl.name = epl.properties.neighborhood;
...
var poss_12044 = epl.polygon.hierarchy.getValue(Cesium.JulianDate.now()).positions;
var cntr_12045 = Cesium.BoundingSphere.fromPoints(poss_12044).center;
var cntr_12046__$1 = Cesium.Ellipsoid.WGS84.scaleToGeodeticSurface(cntr_12045);
epl.position = cntr_12046__$1;
...
var G__12047 = cljs.core.next.call(null,seq__12029__$1);
var G__12048 = null;
var G__12049 = (0);
var G__12050 = (0);
seq__12029 = G__12047;
chunk__12030 = G__12048;
count__12031 = G__12049;
i__12032 = G__12050;
continue;
}
} else {
...
return (function (e){
var pred__12051 = cljs.core._EQ_;
var expr__12052 = tile_sty.options.item(tile_sty.selectedIndex).value;
if(cljs.core.truth_(pred__12051.call(null,"none",expr__12052))){
return city.style = sty_default;
} else {
if(cljs.core.truth_(pred__12051.call(null,"height",expr__12052))){
return city.style = sty_height;
} else {
if(cljs.core.truth_(pred__12051.call(null,"transparent",expr__12052))){
return city.style = sty_transp;
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__12052)].join('')));
}
}
}
});})(city,load_indi,sty_default,sty_transp,sty_height,tile_sty,hoff))
...
cesium.client.load_data.call(null,new cljs.core.Keyword(null,"CZML","CZML",-1539311408),"data/sampleFlight.czml",null,cesium.client.VIEWER,(function (p1__12054_SHARP_){
return cesium.workshop2.client.drone_flight.call(null,p1__12054_SHARP_.entities.getById("Aircraft/Aircraft1"));
}));
