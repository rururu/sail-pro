...
var longitude = cljs.core.get.call(null,map__11865__$1,new cljs.core.Keyword(null,"longitude","longitude",-1268876372));
var latitude = cljs.core.get.call(null,map__11865__$1,new cljs.core.Keyword(null,"latitude","latitude",394867543));
var height = cljs.core.get.call(null,map__11865__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var heading = cljs.core.get.call(null,map__11865__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var pitch = cljs.core.get.call(null,map__11865__$1,new cljs.core.Keyword(null,"pitch","pitch",1495126700));
var roll = cljs.core.get.call(null,map__11865__$1,new cljs.core.Keyword(null,"roll","roll",11266999));
...
cesium.client.VIEWER.homeButton.viewModel.command.beforeExecute.addEventListener(((function (map__11865,map__11865__$1,longitude,latitude,height,heading,pitch,roll,fvw){
return (function (e){
e.cancel = true;

return camera.flyTo(cesium.client.HOME_VIEW);
});})(map__11865,map__11865__$1,longitude,latitude,height,heading,pitch,roll,fvw))
);
...
var animate = cljs.core.get.call(null,map__11869__$1,new cljs.core.Keyword(null,"animate","animate",1850194573));
var start = cljs.core.get.call(null,map__11869__$1,new cljs.core.Keyword(null,"start","start",-355208981));
var stop = cljs.core.get.call(null,map__11869__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
var current = cljs.core.get.call(null,map__11869__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var mult = cljs.core.get.call(null,map__11869__$1,new cljs.core.Keyword(null,"mult","mult",1466794774));
var step = cljs.core.get.call(null,map__11869__$1,new cljs.core.Keyword(null,"step","step",1288888124));
var range = cljs.core.get.call(null,map__11869__$1,new cljs.core.Keyword(null,"range","range",1639692286));
...
clock.clockStep = (function (){var pred__11871 = cljs.core._EQ_;
var expr__11872 = step;
if(cljs.core.truth_(pred__11871.call(null,"TICK_DEPENDENT",expr__11872))){
return Cesium.ClockStep.TICK_DEPENDENT;
} else {
if(cljs.core.truth_(pred__11871.call(null,"SYSTEM_CLOCK_MULTIPLIER",expr__11872))){
return Cesium.ClockStep.SYSTEM_CLOCK_MULTIPLIER;
} else {
if(cljs.core.truth_(pred__11871.call(null,"SYSTEM_CLOCK",expr__11872))){
return Cesium.ClockStep.SYSTEM_CLOCK;
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__11872)].join('')));
}
}
}
})();

clock.clockRange = (function (){var pred__11874 = cljs.core._EQ_;
var expr__11875 = range;
if(cljs.core.truth_(pred__11874.call(null,"UNBOUNDED",expr__11875))){
return Cesium.ClockRange.UNBOUNDED;
} else {
if(cljs.core.truth_(pred__11874.call(null,"CLAMPED",expr__11875))){
return Cesium.ClockRange.CLAMPED;
} else {
if(cljs.core.truth_(pred__11874.call(null,"LOOP_STOP",expr__11875))){
return Cesium.ClockRange.LOOP_STOP;
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__11875)].join('')));
}
}
}
})();
...
var promise = (function (){var pred__11878 = cljs.core._EQ_;
var expr__11879 = format;
if(cljs.core.truth_(pred__11878.call(null,new cljs.core.Keyword(null,"GeoJSON","GeoJSON",33508860),expr__11879))){
return Cesium.GeoJsonDataSource.load(source,options);
} else {
if(cljs.core.truth_(pred__11878.call(null,new cljs.core.Keyword(null,"CZML","CZML",-1539311408),expr__11879))){
return Cesium.CzmlDataSource.load(source,options);
} else {
if(cljs.core.truth_(pred__11878.call(null,new cljs.core.Keyword(null,"KML","KML",1829561453),expr__11879))){
return Cesium.KmlDataSource.load(source,options);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__11879)].join('')));
}
}
}
})();
...
cesium.client.azimuths_AMPERSAND_points = (function cesium$client$azimuths_AMPERSAND_points(p__11882,radr,hgt,N){
var vec__11883 = p__11882;
var c_lambda = cljs.core.nth.call(null,vec__11883,(0),null);
var c_phi = cljs.core.nth.call(null,vec__11883,(1),null);
var s = ((Math.PI * (2)) / N);
var azs = cljs.core.range.call(null,(0),(N * s),s);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [azs,cljs.core.vec.call(null,cljs.core.map.call(null,((function (s,azs,vec__11883,c_lambda,c_phi){
return (function (p1__11881_SHARP_){
return cljs.core.concat.call(null,cesium.client.position_js.call(null,c_lambda,c_phi,radr,p1__11881_SHARP_),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [hgt], null));
});})(s,azs,vec__11883,c_lambda,c_phi))
,azs))], null);
});
...
var vec__11886 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cmp__$1.longitude,cmp__$1.latitude,cmp__$1.height], null);
var lam = cljs.core.nth.call(null,vec__11886,(0),null);
var phi = cljs.core.nth.call(null,vec__11886,(1),null);
var hgt = cljs.core.nth.call(null,vec__11886,(2),null);
var az = camera.heading;
var c = ((((dist_m / (1852)) / (60)) / (180)) * Math.PI);
var vec__11889 = cesium.client.position_js.call(null,lam,phi,c,az);
var lam2 = cljs.core.nth.call(null,vec__11889,(0),null);
var phi2 = cljs.core.nth.call(null,vec__11889,(1),null);
...
return (function (){
var pred__11895 = cljs.core._EQ_;
var expr__11896 = cljs.core.deref.call(null,cesium.client.ORBIT).call(null,new cljs.core.Keyword(null,"status","status",-1997798413));
if(cljs.core.truth_(pred__11895.call(null,new cljs.core.Keyword(null,"init","init",-1875481434),expr__11896))){
...
if(cljs.core.truth_(pred__11895.call(null,new cljs.core.Keyword(null,"stop","stop",-2140911342),expr__11896))){
...
var vec__11898 = cesium.client.look_at.call(null,camera,radm);
var lam = cljs.core.nth.call(null,vec__11898,(0),null);
var phi = cljs.core.nth.call(null,vec__11898,(1),null);
var hgt = cljs.core.nth.call(null,vec__11898,(2),null);
var look = vec__11898;
var vec__11901 = cesium.client.azimuths_AMPERSAND_points.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [lam,phi], null),radr,hgt,steps);
var azs = cljs.core.nth.call(null,vec__11901,(0),null);
var pts = cljs.core.nth.call(null,vec__11901,(1),null);
var ring = cljs.core.vec.call(null,cljs.core.map.call(null,((function (steps,radm,radr,vec__11898,lam,phi,hgt,look,vec__11901,azs,pts,pred__11895,expr__11896,obut){
return (function (p1__11893_SHARP_){
return Cesium.Cartesian3.fromRadians(cljs.core.first.call(null,p1__11893_SHARP_),cljs.core.second.call(null,p1__11893_SHARP_),cljs.core.nth.call(null,p1__11893_SHARP_,(2)));
});})(steps,radm,radr,vec__11898,lam,phi,hgt,look,vec__11901,azs,pts,pred__11895,expr__11896,obut))
,pts));
var headings = cljs.core.vec.call(null,cljs.core.map.call(null,((function (steps,radm,radr,vec__11898,lam,phi,hgt,look,vec__11901,azs,pts,ring,pred__11895,expr__11896,obut){
return (function (p1__11894_SHARP_){
return cesium.client.normaz.call(null,(p1__11894_SHARP_ + Math.PI));
});})(steps,radm,radr,vec__11898,lam,phi,hgt,look,vec__11901,azs,pts,ring,pred__11895,expr__11896,obut))
,azs));
...
if(cljs.core.truth_(pred__11895.call(null,new cljs.core.Keyword(null,"run","run",-1821166653),expr__11896))){
camera.cancelFlight();

return cljs.core._vreset_BANG_.call(null,cesium.client.ORBIT,cljs.core.assoc.call(null,cljs.core._deref.call(null,cesium.client.ORBIT),new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"stop","stop",-2140911342)));
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__11896)].join('')));
}
}
}
});})(obut))
