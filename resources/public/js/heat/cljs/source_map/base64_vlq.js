...
var digit_20539 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_20540__$1 = (vlq >>> (5));
while(true){
if((vlq_20540__$1 > (0))){
var digit_20541__$1 = (digit_20539 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_20541__$1));

var G__20542 = (vlq_20540__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__20543 = (vlq_20540__$1 >>> (5));
digit_20539 = G__20542;
vlq_20540__$1 = G__20543;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_20539));
}
break;
}
...
var G__20544 = i__$1;
var G__20545 = result__$1;
var G__20546 = shift__$1;
i = G__20544;
result = G__20545;
shift = G__20546;
continue;
