...
return Cesium.defined(p1__24493_SHARP_.billboard);
});})(vals,kmlops,promise))
,vals);
var seq__24494 = cljs.core.seq.call(null,ebbs);
var chunk__24495 = null;
var count__24496 = (0);
var i__24497 = (0);
while(true){
if((i__24497 < count__24496)){
var ebb = cljs.core._nth.call(null,chunk__24495,i__24497);
...
var pos_24498 = ebb.position.getValue(Cesium.JulianDate.now());
var pos_24499__$1 = Cesium.Cartographic.fromCartesian(pos_24498);
var lat_24500 = Cesium.Math.toDegrees(pos_24499__$1.latitude);
var lon_24501 = Cesium.Math.toDegrees(pos_24499__$1.longitude);
var desc_24502 = ["<table class=\"cesium-infoBox-defaultTable cesium-infoBox-defaultTable-lighter\"><tbody>","<tr><th>Longitude</th><td>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(lon_24501.toFixed((5))),"</td></tr>","<tr><th>Latitude</th><td>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(lat_24500.toFixed((5))),"</td></tr>","</tbody></table>"].join('');
ebb.description = desc_24502;


var G__24503 = seq__24494;
var G__24504 = chunk__24495;
var G__24505 = count__24496;
var G__24506 = (i__24497 + (1));
seq__24494 = G__24503;
chunk__24495 = G__24504;
count__24496 = G__24505;
i__24497 = G__24506;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq.call(null,seq__24494);
if(temp__5735__auto__){
var seq__24494__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__24494__$1)){
var c__4461__auto__ = cljs.core.chunk_first.call(null,seq__24494__$1);
var G__24507 = cljs.core.chunk_rest.call(null,seq__24494__$1);
var G__24508 = c__4461__auto__;
var G__24509 = cljs.core.count.call(null,c__4461__auto__);
var G__24510 = (0);
seq__24494 = G__24507;
chunk__24495 = G__24508;
count__24496 = G__24509;
i__24497 = G__24510;
continue;
} else {
var ebb = cljs.core.first.call(null,seq__24494__$1);
ebb.billboard.verticalOrigin = Cesium.VerticalOrigin.BOTTOM;
...
var pos_24511 = ebb.position.getValue(Cesium.JulianDate.now());
var pos_24512__$1 = Cesium.Cartographic.fromCartesian(pos_24511);
var lat_24513 = Cesium.Math.toDegrees(pos_24512__$1.latitude);
var lon_24514 = Cesium.Math.toDegrees(pos_24512__$1.longitude);
var desc_24515 = ["<table class=\"cesium-infoBox-defaultTable cesium-infoBox-defaultTable-lighter\"><tbody>","<tr><th>Longitude</th><td>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(lon_24514.toFixed((5))),"</td></tr>","<tr><th>Latitude</th><td>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(lat_24513.toFixed((5))),"</td></tr>","</tbody></table>"].join('');
ebb.description = desc_24515;


var G__24516 = cljs.core.next.call(null,seq__24494__$1);
var G__24517 = null;
var G__24518 = (0);
var G__24519 = (0);
seq__24494 = G__24516;
chunk__24495 = G__24517;
count__24496 = G__24518;
i__24497 = G__24519;
continue;
}
} else {
...
return Cesium.defined(p1__24520_SHARP_.polygon);
});})(vals,promise))
,vals);
var seq__24521 = cljs.core.seq.call(null,epls);
var chunk__24522 = null;
var count__24523 = (0);
var i__24524 = (0);
while(true){
if((i__24524 < count__24523)){
var epl = cljs.core._nth.call(null,chunk__24522,i__24524);
...
var poss_24525 = epl.polygon.hierarchy.getValue(Cesium.JulianDate.now()).positions;
var cntr_24526 = Cesium.BoundingSphere.fromPoints(poss_24525).center;
var cntr_24527__$1 = Cesium.Ellipsoid.WGS84.scaleToGeodeticSurface(cntr_24526);
epl.position = cntr_24527__$1;
...
var G__24528 = seq__24521;
var G__24529 = chunk__24522;
var G__24530 = count__24523;
var G__24531 = (i__24524 + (1));
seq__24521 = G__24528;
chunk__24522 = G__24529;
count__24523 = G__24530;
i__24524 = G__24531;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq.call(null,seq__24521);
if(temp__5735__auto__){
var seq__24521__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__24521__$1)){
var c__4461__auto__ = cljs.core.chunk_first.call(null,seq__24521__$1);
var G__24532 = cljs.core.chunk_rest.call(null,seq__24521__$1);
var G__24533 = c__4461__auto__;
var G__24534 = cljs.core.count.call(null,c__4461__auto__);
var G__24535 = (0);
seq__24521 = G__24532;
chunk__24522 = G__24533;
count__24523 = G__24534;
i__24524 = G__24535;
continue;
} else {
var epl = cljs.core.first.call(null,seq__24521__$1);
epl.name = epl.properties.neighborhood;
...
var poss_24536 = epl.polygon.hierarchy.getValue(Cesium.JulianDate.now()).positions;
var cntr_24537 = Cesium.BoundingSphere.fromPoints(poss_24536).center;
var cntr_24538__$1 = Cesium.Ellipsoid.WGS84.scaleToGeodeticSurface(cntr_24537);
epl.position = cntr_24538__$1;
...
var G__24539 = cljs.core.next.call(null,seq__24521__$1);
var G__24540 = null;
var G__24541 = (0);
var G__24542 = (0);
seq__24521 = G__24539;
...
return (function (e){
var pred__24543 = cljs.core._EQ_;
var expr__24544 = tile_sty.options.item(tile_sty.selectedIndex).value;
if(cljs.core.truth_(pred__24543.call(null,"none",expr__24544))){
return city.style = sty_default;
} else {
if(cljs.core.truth_(pred__24543.call(null,"height",expr__24544))){
return city.style = sty_height;
} else {
if(cljs.core.truth_(pred__24543.call(null,"transparent",expr__24544))){
return city.style = sty_transp;
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__24544)].join('')));
}
}
}
});})(city,load_indi,sty_default,sty_transp,sty_height,tile_sty,hoff))
