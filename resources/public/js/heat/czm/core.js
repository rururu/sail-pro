...
czm.core.sample_height = (function czm$core$sample_height(p__24565,alt){
var vec__24566 = p__24565;
var phi = cljs.core.nth.call(null,vec__24566,(0),null);
var lam = cljs.core.nth.call(null,vec__24566,(1),null);
...
var vec__24569 = czm.core.sample_height.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [geo.calc.radians.call(null,lat),geo.calc.radians.call(null,lon)], null),czm.core.ALT);
var _ = cljs.core.nth.call(null,vec__24569,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__24569,(1),null);
var sh = cljs.core.nth.call(null,vec__24569,(2),null);
if((sh > (-7777))){
...
return czm.core.sample_height.call(null,p1__24572_SHARP_,alt);
});})(ray))
,ray);
});
...
if((h2 <= alt)){
var G__24573 = fr;
var G__24574 = cljs.core.rest.call(null,r);
f = G__24573;
r = G__24574;
continue;
} else {
...
var vec__24575 = center;
var lat = cljs.core.nth.call(null,vec__24575,(0),null);
var lon = cljs.core.nth.call(null,vec__24575,(1),null);
var vec__24578 = sector;
var start = cljs.core.nth.call(null,vec__24578,(0),null);
var end = cljs.core.nth.call(null,vec__24578,(1),null);
var losec = (function (){var iter__4434__auto__ = ((function (vec__24575,lat,lon,vec__24578,start,end){
return (function czm$core$los_sector_$_iter__24581(s__24582){
return (new cljs.core.LazySeq(null,((function (vec__24575,lat,lon,vec__24578,start,end){
return (function (){
var s__24582__$1 = s__24582;
while(true){
var temp__5735__auto__ = cljs.core.seq.call(null,s__24582__$1);
if(temp__5735__auto__){
var s__24582__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__24582__$2)){
var c__4432__auto__ = cljs.core.chunk_first.call(null,s__24582__$2);
var size__4433__auto__ = cljs.core.count.call(null,c__4432__auto__);
var b__24584 = cljs.core.chunk_buffer.call(null,size__4433__auto__);
if((function (){var i__24583 = (0);
while(true){
if((i__24583 < size__4433__auto__)){
var bea = cljs.core._nth.call(null,c__4432__auto__,i__24583);
cljs.core.chunk_append.call(null,b__24584,czm.core.los_end.call(null,lat,lon,bea,dist,dist_step,alt));

var G__24585 = (i__24583 + (1));
i__24583 = G__24585;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__24584),czm$core$los_sector_$_iter__24581.call(null,cljs.core.chunk_rest.call(null,s__24582__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__24584),null);
}
} else {
var bea = cljs.core.first.call(null,s__24582__$2);
return cljs.core.cons.call(null,czm.core.los_end.call(null,lat,lon,bea,dist,dist_step,alt),czm$core$los_sector_$_iter__24581.call(null,cljs.core.rest.call(null,s__24582__$2)));
}
} else {
return null;
}
...
});})(vec__24575,lat,lon,vec__24578,start,end))
,null,null));
});})(vec__24575,lat,lon,vec__24578,start,end))
;
