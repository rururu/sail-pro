...
var digit_2492 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_2493__$1 = (vlq >>> (5));
while(true){
if((vlq_2493__$1 > (0))){
var digit_2494__$1 = (digit_2492 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_2494__$1));

var G__2495 = (vlq_2493__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__2496 = (vlq_2493__$1 >>> (5));
digit_2492 = G__2495;
vlq_2493__$1 = G__2496;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_2492));
}
break;
}
...
var G__2497 = i__$1;
var G__2498 = result__$1;
var G__2499 = shift__$1;
i = G__2497;
result = G__2498;
shift = G__2499;
continue;
