...
goog.provide('cesium.drape.client');
goog.require('cljs.core');
goog.require('cesium.client');
cesium.drape.client.init_drape = (function cesium$drape$client$init_drape(){
...
window.onload = cesium.drape.client.init_drape.call(null);
