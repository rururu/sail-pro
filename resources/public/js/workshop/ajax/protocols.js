...
ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4303__auto__,k892,else__4304__auto__){
var self__ = this;
var this__4303__auto____$1 = this;
var G__896 = k892;
var G__896__$1 = (((G__896 instanceof cljs.core.Keyword))?G__896.fqn:null);
switch (G__896__$1) {
case "status":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k892,else__4304__auto__);
...
return (function (ret__4323__auto__,p__897){
var vec__898 = p__897;
var k__4324__auto__ = cljs.core.nth.call(null,vec__898,(0),null);
var v__4325__auto__ = cljs.core.nth.call(null,vec__898,(1),null);
...
ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__891){
var self__ = this;
var G__891__$1 = this;
return (new cljs.core.RecordIter((0),G__891__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this893,other894){
var self__ = this;
var this893__$1 = this;
return (((!((other894 == null)))) && ((this893__$1.constructor === other894.constructor)) && (cljs.core._EQ_.call(null,this893__$1.status,other894.status)) && (cljs.core._EQ_.call(null,this893__$1.body,other894.body)) && (cljs.core._EQ_.call(null,this893__$1.status_text,other894.status_text)) && (cljs.core._EQ_.call(null,this893__$1.headers,other894.headers)) && (cljs.core._EQ_.call(null,this893__$1.was_aborted,other894.was_aborted)) && (cljs.core._EQ_.call(null,this893__$1.__extmap,other894.__extmap)));
});
...
ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4308__auto__,k__4309__auto__,G__891){
var self__ = this;
var this__4308__auto____$1 = this;
var pred__901 = cljs.core.keyword_identical_QMARK_;
var expr__902 = k__4309__auto__;
if(cljs.core.truth_(pred__901.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__902))){
return (new ajax.protocols.Response(G__891,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__901.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__902))){
return (new ajax.protocols.Response(self__.status,G__891,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__901.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__902))){
return (new ajax.protocols.Response(self__.status,self__.body,G__891,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__901.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__902))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__891,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__901.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__902))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__891,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4309__auto__,G__891),null));
}
}
}
}
...
ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4300__auto__,G__891){
var self__ = this;
var this__4300__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__891,self__.__extmap,self__.__hash));
});
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__895){
var extmap__4340__auto__ = (function (){var G__904 = cljs.core.dissoc.call(null,G__895,new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828));
if(cljs.core.record_QMARK_.call(null,G__895)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__904);
} else {
return G__904;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__895),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__895),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__895),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__895),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__895),null,cljs.core.not_empty.call(null,extmap__4340__auto__),null));
});
