...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__4858){
var map__4859 = p__4858;
var map__4859__$1 = (((((!((map__4859 == null))))?(((((map__4859.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__4859.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__4859):map__4859);
var handler = cljs.core.get.call(null,map__4859__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__4047__auto__ = p1__4861_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__4862){
var map__4863 = p__4862;
var map__4863__$1 = (((((!((map__4863 == null))))?(((((map__4863.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__4863.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__4863):map__4863);
var request = map__4863__$1;
var interceptors = cljs.core.get.call(null,map__4863__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
