...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__4622){
var map__4623 = p__4622;
var map__4623__$1 = (((((!((map__4623 == null))))?(((((map__4623.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__4623.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__4623):map__4623);
var request = map__4623__$1;
var response_format = cljs.core.get.call(null,map__4623__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
ajax.formats.accept_header = (function ajax$formats$accept_header(p__4628){
var map__4629 = p__4628;
var map__4629__$1 = (((((!((map__4629 == null))))?(((((map__4629.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__4629.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__4629):map__4629);
var request = map__4629__$1;
var response_format = cljs.core.get.call(null,map__4629__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
