...
var G__8388 = format;
var G__8388__$1 = (((G__8388 instanceof cljs.core.Keyword))?G__8388.fqn:null);
switch (G__8388__$1) {
case "transit":
return ajax.transit.transit_request_format.call(null,format_params);
...
var G__8390 = format;
var G__8390__$1 = (((G__8390 instanceof cljs.core.Keyword))?G__8390.fqn:null);
switch (G__8390__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_.call(null,format)){
return cljs.core.apply.call(null,cljs.core.vector,cljs.core.map.call(null,(function (p1__8392_SHARP_){
return ajax.easy.keyword_response_format_element.call(null,p1__8392_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__8393){
var map__8394 = p__8393;
var map__8394__$1 = (((((!((map__8394 == null))))?(((((map__8394.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__8394.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8394):map__8394);
var handler = cljs.core.get.call(null,map__8394__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.call(null,map__8394__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.call(null,map__8394__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return ((function (h,e,map__8394,map__8394__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__8396){
var vec__8397 = p__8396;
var ok = cljs.core.nth.call(null,vec__8397,(0),null);
var result = cljs.core.nth.call(null,vec__8397,(1),null);
...
;})(h,e,map__8394,map__8394__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__8400){
...
var opts = map__8401__$1;
var method = cljs.core.get.call(null,map__8401__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.call(null,map__8401__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.call(null,map__8401__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.call(null,map__8401__$1,new cljs.core.Keyword(null,"params","params",710516235));
