...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__7180){
var map__7181 = p__7180;
var map__7181__$1 = (((((!((map__7181 == null))))?(((((map__7181.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__7181.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7181):map__7181);
var handler = cljs.core.get.call(null,map__7181__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__4047__auto__ = p1__7183_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__7184){
...
var interceptors = cljs.core.get.call(null,map__7185__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
