...
return ajax.formats.content_type_matches.call(null,content_type,p1__10639_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__10640){
var map__10641 = p__10640;
var map__10641__$1 = cljs.core.__destructure_map.call(null,map__10641);
var request = map__10641__$1;
var response_format = cljs.core.get.call(null,map__10641__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
ajax.formats.accept_header = (function ajax$formats$accept_header(p__10643){
var map__10644 = p__10643;
var map__10644__$1 = cljs.core.__destructure_map.call(null,map__10644);
var request = map__10644__$1;
var response_format = cljs.core.get.call(null,map__10644__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.call(null,(function (p1__10642_SHARP_){
return ajax.formats.get_accept_entries.call(null,request,p1__10642_SHARP_);
}),formats);
});
/**
