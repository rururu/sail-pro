...
light.czm.core.sample_height = (function light$czm$core$sample_height(p__4569,alt){
var vec__4570 = p__4569;
var phi = cljs.core.nth.call(null,vec__4570,(0),null);
var lam = cljs.core.nth.call(null,vec__4570,(1),null);
...
var vec__4573 = light.czm.core.sample_height.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [light.geo.calc.radians.call(null,lat),light.geo.calc.radians.call(null,lon)], null),light.czm.core.ALT);
var _ = cljs.core.nth.call(null,vec__4573,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__4573,(1),null);
var sh = cljs.core.nth.call(null,vec__4573,(2),null);
if((sh > (-7777))){
...
return light.czm.core.sample_height.call(null,p1__4576_SHARP_,alt);
});})(ray))
,ray);
});
...
if((h2 <= alt)){
var G__4577 = fr;
var G__4578 = cljs.core.rest.call(null,r);
f = G__4577;
r = G__4578;
continue;
} else {
...
var vec__4579 = center;
var lat = cljs.core.nth.call(null,vec__4579,(0),null);
var lon = cljs.core.nth.call(null,vec__4579,(1),null);
var vec__4582 = sector;
var start = cljs.core.nth.call(null,vec__4582,(0),null);
var end = cljs.core.nth.call(null,vec__4582,(1),null);
var losec = (function (){var iter__4434__auto__ = ((function (vec__4579,lat,lon,vec__4582,start,end){
return (function light$czm$core$los_sector_$_iter__4585(s__4586){
return (new cljs.core.LazySeq(null,((function (vec__4579,lat,lon,vec__4582,start,end){
return (function (){
var s__4586__$1 = s__4586;
while(true){
var temp__5735__auto__ = cljs.core.seq.call(null,s__4586__$1);
if(temp__5735__auto__){
var s__4586__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__4586__$2)){
var c__4432__auto__ = cljs.core.chunk_first.call(null,s__4586__$2);
var size__4433__auto__ = cljs.core.count.call(null,c__4432__auto__);
var b__4588 = cljs.core.chunk_buffer.call(null,size__4433__auto__);
if((function (){var i__4587 = (0);
while(true){
if((i__4587 < size__4433__auto__)){
var bea = cljs.core._nth.call(null,c__4432__auto__,i__4587);
cljs.core.chunk_append.call(null,b__4588,light.czm.core.los_end.call(null,lat,lon,bea,dist,dist_step,alt));

var G__4589 = (i__4587 + (1));
i__4587 = G__4589;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__4588),light$czm$core$los_sector_$_iter__4585.call(null,cljs.core.chunk_rest.call(null,s__4586__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__4588),null);
}
} else {
var bea = cljs.core.first.call(null,s__4586__$2);
return cljs.core.cons.call(null,light.czm.core.los_end.call(null,lat,lon,bea,dist,dist_step,alt),light$czm$core$los_sector_$_iter__4585.call(null,cljs.core.rest.call(null,s__4586__$2)));
}
} else {
return null;
}
...
});})(vec__4579,lat,lon,vec__4582,start,end))
,null,null));
});})(vec__4579,lat,lon,vec__4582,start,end))
;
