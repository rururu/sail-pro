...
light.czm.core.ZOOM = cljs.core.List.EMPTY;
...
light.czm.core.sample_height = (function light$czm$core$sample_height(p__16555,alt){
var vec__16556 = p__16555;
var phi = cljs.core.nth.call(null,vec__16556,(0),null);
var lam = cljs.core.nth.call(null,vec__16556,(1),null);
...
var vec__16559 = light.czm.core.sample_height.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [light.geo.calc.radians.call(null,lat),light.geo.calc.radians.call(null,lon)], null),light.czm.core.ALT);
var _ = cljs.core.nth.call(null,vec__16559,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__16559,(1),null);
var sh = cljs.core.nth.call(null,vec__16559,(2),null);
if((sh > (-7777))){
...
return light.czm.core.sample_height.call(null,p1__16562_SHARP_,alt);
});})(ray))
,ray);
});
...
if((h2 <= alt)){
var G__16563 = fr;
var G__16564 = cljs.core.rest.call(null,r);
f = G__16563;
r = G__16564;
continue;
} else {
...
var vec__16565 = center;
var lat = cljs.core.nth.call(null,vec__16565,(0),null);
var lon = cljs.core.nth.call(null,vec__16565,(1),null);
var vec__16568 = sector;
var start = cljs.core.nth.call(null,vec__16568,(0),null);
var end = cljs.core.nth.call(null,vec__16568,(1),null);
var losec = (function (){var iter__4434__auto__ = ((function (vec__16565,lat,lon,vec__16568,start,end){
return (function light$czm$core$los_sector_$_iter__16571(s__16572){
return (new cljs.core.LazySeq(null,((function (vec__16565,lat,lon,vec__16568,start,end){
return (function (){
var s__16572__$1 = s__16572;
while(true){
var temp__5735__auto__ = cljs.core.seq.call(null,s__16572__$1);
if(temp__5735__auto__){
var s__16572__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__16572__$2)){
var c__4432__auto__ = cljs.core.chunk_first.call(null,s__16572__$2);
var size__4433__auto__ = cljs.core.count.call(null,c__4432__auto__);
var b__16574 = cljs.core.chunk_buffer.call(null,size__4433__auto__);
if((function (){var i__16573 = (0);
while(true){
if((i__16573 < size__4433__auto__)){
var bea = cljs.core._nth.call(null,c__4432__auto__,i__16573);
cljs.core.chunk_append.call(null,b__16574,light.czm.core.los_end.call(null,lat,lon,bea,dist,dist_step,alt));

var G__16575 = (i__16573 + (1));
i__16573 = G__16575;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__16574),light$czm$core$los_sector_$_iter__16571.call(null,cljs.core.chunk_rest.call(null,s__16572__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__16574),null);
}
} else {
var bea = cljs.core.first.call(null,s__16572__$2);
return cljs.core.cons.call(null,light.czm.core.los_end.call(null,lat,lon,bea,dist,dist_step,alt),light$czm$core$los_sector_$_iter__16571.call(null,cljs.core.rest.call(null,s__16572__$2)));
}
} else {
return null;
}
...
});})(vec__16565,lat,lon,vec__16568,start,end))
,null,null));
});})(vec__16565,lat,lon,vec__16568,start,end))
;
...
return (
light.czm.core.ZOOM = cljs.core.conj.call(null,light.czm.core.ZOOM,light.czm.core.ZOOM_AMOUNT))
;
});
light.czm.core.zoom_out = (function light$czm$core$zoom_out(){
if(cljs.core.seq.call(null,light.czm.core.ZOOM)){
light.czm.core.VIEWER.camera.zoomOut(cljs.core.first.call(null,light.czm.core.ZOOM));

return (
light.czm.core.ZOOM = cljs.core.rest.call(null,light.czm.core.ZOOM))
;
} else {
return null;
}
