...
light.czm.core.sample_height = (function light$czm$core$sample_height(p__21871,alt){
var vec__21872 = p__21871;
var phi = cljs.core.nth.call(null,vec__21872,(0),null);
var lam = cljs.core.nth.call(null,vec__21872,(1),null);
...
var vec__21875 = light.czm.core.sample_height.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [light.geo.calc.radians.call(null,lat),light.geo.calc.radians.call(null,lon)], null),light.czm.core.ALT);
var _ = cljs.core.nth.call(null,vec__21875,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__21875,(1),null);
var sh = cljs.core.nth.call(null,vec__21875,(2),null);
if((sh > (-7777))){
...
return light.czm.core.sample_height.call(null,p1__21878_SHARP_,alt);
});})(ray))
,ray);
});
...
if((h2 <= alt)){
var G__21879 = fr;
var G__21880 = cljs.core.rest.call(null,r);
f = G__21879;
r = G__21880;
continue;
} else {
...
var vec__21881 = center;
var lat = cljs.core.nth.call(null,vec__21881,(0),null);
var lon = cljs.core.nth.call(null,vec__21881,(1),null);
var vec__21884 = sector;
var start = cljs.core.nth.call(null,vec__21884,(0),null);
var end = cljs.core.nth.call(null,vec__21884,(1),null);
var losec = (function (){var iter__4434__auto__ = ((function (vec__21881,lat,lon,vec__21884,start,end){
return (function light$czm$core$los_sector_$_iter__21887(s__21888){
return (new cljs.core.LazySeq(null,((function (vec__21881,lat,lon,vec__21884,start,end){
return (function (){
var s__21888__$1 = s__21888;
while(true){
var temp__5735__auto__ = cljs.core.seq.call(null,s__21888__$1);
if(temp__5735__auto__){
var s__21888__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__21888__$2)){
var c__4432__auto__ = cljs.core.chunk_first.call(null,s__21888__$2);
var size__4433__auto__ = cljs.core.count.call(null,c__4432__auto__);
var b__21890 = cljs.core.chunk_buffer.call(null,size__4433__auto__);
if((function (){var i__21889 = (0);
while(true){
if((i__21889 < size__4433__auto__)){
var bea = cljs.core._nth.call(null,c__4432__auto__,i__21889);
cljs.core.chunk_append.call(null,b__21890,light.czm.core.los_end.call(null,lat,lon,bea,dist,dist_step,alt));

var G__21891 = (i__21889 + (1));
i__21889 = G__21891;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__21890),light$czm$core$los_sector_$_iter__21887.call(null,cljs.core.chunk_rest.call(null,s__21888__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__21890),null);
}
} else {
var bea = cljs.core.first.call(null,s__21888__$2);
return cljs.core.cons.call(null,light.czm.core.los_end.call(null,lat,lon,bea,dist,dist_step,alt),light$czm$core$los_sector_$_iter__21887.call(null,cljs.core.rest.call(null,s__21888__$2)));
}
} else {
return null;
}
...
});})(vec__21881,lat,lon,vec__21884,start,end))
,null,null));
});})(vec__21881,lat,lon,vec__21884,start,end))
;
