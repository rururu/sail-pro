...
light.czm.core.sample_height = (function light$czm$core$sample_height(p__11860,alt){
var vec__11861 = p__11860;
var phi = cljs.core.nth.call(null,vec__11861,(0),null);
var lam = cljs.core.nth.call(null,vec__11861,(1),null);
...
var vec__11864 = light.czm.core.sample_height.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [light.geo.calc.radians.call(null,lat),light.geo.calc.radians.call(null,lon)], null),light.czm.core.ALT);
var _ = cljs.core.nth.call(null,vec__11864,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__11864,(1),null);
var sh = cljs.core.nth.call(null,vec__11864,(2),null);
if((sh > (-7777))){
...
return light.czm.core.sample_height.call(null,p1__11867_SHARP_,alt);
});})(ray))
,ray);
});
...
if((h2 <= alt)){
var G__11868 = fr;
var G__11869 = cljs.core.rest.call(null,r);
f = G__11868;
r = G__11869;
continue;
} else {
...
var vec__11870 = center;
var lat = cljs.core.nth.call(null,vec__11870,(0),null);
var lon = cljs.core.nth.call(null,vec__11870,(1),null);
var vec__11873 = sector;
var start = cljs.core.nth.call(null,vec__11873,(0),null);
var end = cljs.core.nth.call(null,vec__11873,(1),null);
var losec = (function (){var iter__4434__auto__ = ((function (vec__11870,lat,lon,vec__11873,start,end){
return (function light$czm$core$los_sector_$_iter__11876(s__11877){
return (new cljs.core.LazySeq(null,((function (vec__11870,lat,lon,vec__11873,start,end){
return (function (){
var s__11877__$1 = s__11877;
while(true){
var temp__5735__auto__ = cljs.core.seq.call(null,s__11877__$1);
if(temp__5735__auto__){
var s__11877__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__11877__$2)){
var c__4432__auto__ = cljs.core.chunk_first.call(null,s__11877__$2);
var size__4433__auto__ = cljs.core.count.call(null,c__4432__auto__);
var b__11879 = cljs.core.chunk_buffer.call(null,size__4433__auto__);
if((function (){var i__11878 = (0);
while(true){
if((i__11878 < size__4433__auto__)){
var bea = cljs.core._nth.call(null,c__4432__auto__,i__11878);
cljs.core.chunk_append.call(null,b__11879,light.czm.core.los_end.call(null,lat,lon,bea,dist,dist_step,alt));
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__11879),light$czm$core$los_sector_$_iter__11876.call(null,cljs.core.chunk_rest.call(null,s__11877__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__11879),null);
}
} else {
var bea = cljs.core.first.call(null,s__11877__$2);
return cljs.core.cons.call(null,light.czm.core.los_end.call(null,lat,lon,bea,dist,dist_step,alt),light$czm$core$los_sector_$_iter__11876.call(null,cljs.core.rest.call(null,s__11877__$2)));
}
} else {
return null;
}
...
});})(vec__11870,lat,lon,vec__11873,start,end))
,null,null));
});})(vec__11870,lat,lon,vec__11873,start,end))
;
