...
var G__3549 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__3549;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__3550 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__3550,ch);
...
if(("\\" === ch__$1)){
var ch_3551__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_3551__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_3551__$2);
} else {
}

var G__3552 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__3552;
continue;
}
}
...
var vec__3560 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__3560,(0),null);
var start_column = cljs.core.nth.call(null,vec__3560,(1),null);
...
var G__3563 = cljs.core.conj_BANG_.call(null,a,form);
a = G__3563;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__3564 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__3565 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__3565;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__3564;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__3566 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__3566,(0),null);
var start_column = cljs.core.nth.call(null,vec__3566,(1),null);
...
var vec__3569 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__3569,(0),null);
var end_column = cljs.core.nth.call(null,vec__3569,(1),null);
...
var vec__3572 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__3572,(0),null);
var start_column = cljs.core.nth.call(null,vec__3572,(1),null);
...
var vec__3575 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__3575,(0),null);
var end_column = cljs.core.nth.call(null,vec__3575,(1),null);
...
var vec__3578 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__3578,(0),null);
var start_column = cljs.core.nth.call(null,vec__3578,(1),null);
...
var vec__3581 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__3581,(0),null);
var end_column = cljs.core.nth.call(null,vec__3581,(1),null);
...
var sb = (function (){var G__3584 = (new goog.string.StringBuffer());
G__3584.append(initch);
...
var G__3586 = (function (){var G__3585 = sb;
G__3585.append(ch);

return G__3585;
})();
var G__3587 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__3586;
ch = G__3587;
continue;
}
...
switch (G__3590) {
case "\\":
var G__3594 = (function (){var G__3591 = sb;
G__3591.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__3591;
})();
var G__3595 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__3594;
ch = G__3595;
continue;
...
break;
default:
var G__3596 = (function (){var G__3592 = sb;
G__3592.append(ch);

return G__3592;
})();
var G__3597 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__3596;
ch = G__3597;
continue;
...
var vec__3598 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__3598,(0),null);
var end_column = cljs.core.nth.call(null,vec__3598,(1),null);
...
var vec__3601 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__3601,(0),null);
var column = cljs.core.nth.call(null,vec__3601,(1),null);
...
var vec__3606 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__3606,(0),null);
var column = cljs.core.nth.call(null,vec__3606,(1),null);
...
var vec__3611 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__3611,(0),null);
var column = cljs.core.nth.call(null,vec__3611,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__3616 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__3616,(0),null);
var start_column = cljs.core.nth.call(null,vec__3616,(1),null);
...
var vec__3619 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__3619,(0),null);
var end_column = cljs.core.nth.call(null,vec__3619,(1),null);
...
var G__3622 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__3622,true,null,opts,pending_forms);
...
var G__3623 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__3623)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__3623)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__3623)){
...
var _STAR_suppress_read_STAR__orig_val__3624 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__3625 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__3625;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__3624;
}});
...
var G__3626 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__3626,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__3626,rdr,first_line);
...
var G__3630 = matched;
var G__3631 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__3630;
finished = G__3631;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__3632 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__3633 = (function (){var or__4047__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__3633;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__3632;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__3634 = cljs.tools.reader.arg_env;
var arg_env_temp_val__3635 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__3635;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__3636 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__3636,"(");
...
var G__3637 = (i + (1));
var G__3638 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4047__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__3634;
}});
/**
...
var ch = temp__5733__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__3639 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__3639);
...
var G__3642 = cljs.core.next.call(null,s);
var G__3643 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__3642;
key_vals = G__3643;
continue;
} else {
...
var gensym_env_orig_val__3647 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__3648 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__3648;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__3647;
}});
...
var temp__5733__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__3649 = token;
var G__3649__$1 = (((G__3649 == null))?null:cljs.core.subs.call(null,G__3649,(1)));
var G__3649__$2 = (((G__3649__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__3649__$1));
var G__3649__$3 = (((G__3649__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__3649__$2));
var G__3649__$4 = (((G__3649__$3 == null))?null:cljs.core.symbol.call(null,G__3649__$3));
if((G__3649__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__3649__$4);
}
})():(function (){var G__3650 = token;
var G__3650__$1 = (((G__3650 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__3650));
if((G__3650__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__3650__$1);
}
})()
));
if(cljs.core.truth_(temp__5733__auto__)){
...
}catch (e3657){if((e3657 instanceof Error)){
var e = e3657;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__3661,reader){
var map__3662 = p__3661;
var map__3662__$1 = (((((!((map__3662 == null))))?(((((map__3662.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__3662.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__3662):map__3662);
var opts = map__3662__$1;
var eof = cljs.core.get.call(null,map__3662__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4641__auto___3670 = arguments.length;
var i__4642__auto___3671 = (0);
while(true){
if((i__4642__auto___3671 < len__4641__auto___3670)){
args__4647__auto__.push((arguments[i__4642__auto___3671]));

var G__3672 = (i__4642__auto___3671 + (1));
i__4642__auto___3671 = G__3672;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq3668){
var G__3669 = cljs.core.first.call(null,seq3668);
var seq3668__$1 = cljs.core.next.call(null,seq3668);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__3669,seq3668__$1);
});
