...
var G__2809 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__2809;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__2810 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__2810,ch);
...
if(("\\" === ch__$1)){
var ch_2811__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_2811__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_2811__$2);
} else {
}

var G__2812 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__2812;
continue;
}
}
...
var vec__2820 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__2820,(0),null);
var start_column = cljs.core.nth.call(null,vec__2820,(1),null);
...
var G__2823 = cljs.core.conj_BANG_.call(null,a,form);
a = G__2823;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__2824 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__2825 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__2825);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__2824);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__2826 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__2826,(0),null);
var start_column = cljs.core.nth.call(null,vec__2826,(1),null);
...
var vec__2829 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__2829,(0),null);
var end_column = cljs.core.nth.call(null,vec__2829,(1),null);
...
var vec__2832 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__2832,(0),null);
var start_column = cljs.core.nth.call(null,vec__2832,(1),null);
...
var start_line = cljs.core.nth.call(null,vec__2838,(0),null);
var start_column = cljs.core.nth.call(null,vec__2838,(1),null);
...
var vec__2841 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__2841,(0),null);
var end_column = cljs.core.nth.call(null,vec__2841,(1),null);
...
var sb = (function (){var G__2844 = (new goog.string.StringBuffer());
G__2844.append(initch);
...
var G__2846 = (function (){var G__2845 = sb;
G__2845.append(ch);

return G__2845;
})();
var G__2847 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__2846;
ch = G__2847;
continue;
}
...
switch (G__2850) {
case "\\":
var G__2854 = (function (){var G__2851 = sb;
G__2851.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__2851;
})();
var G__2855 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__2854;
ch = G__2855;
continue;
...
break;
default:
var G__2856 = (function (){var G__2852 = sb;
G__2852.append(ch);

return G__2852;
})();
var G__2857 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__2856;
ch = G__2857;
continue;
...
var vec__2861 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__2861,(0),null);
var column = cljs.core.nth.call(null,vec__2861,(1),null);
...
var vec__2866 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__2866,(0),null);
var column = cljs.core.nth.call(null,vec__2866,(1),null);
...
var vec__2871 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__2871,(0),null);
var column = cljs.core.nth.call(null,vec__2871,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__2876 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__2876,(0),null);
var start_column = cljs.core.nth.call(null,vec__2876,(1),null);
...
var vec__2879 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__2879,(0),null);
var end_column = cljs.core.nth.call(null,vec__2879,(1),null);
...
var G__2882 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__2882,true,null,opts,pending_forms);
...
var G__2883 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__2883)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__2883)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__2883)){
...
var _STAR_suppress_read_STAR__orig_val__2884 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__2885 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__2885);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__2884);
}});
...
var G__2886 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__2886,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__2886,rdr,first_line);
...
var G__2890 = matched;
var G__2891 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__2890;
finished = G__2891;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__2892 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__2893 = (function (){var or__5002__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__2893);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__2892);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__2894 = cljs.tools.reader.arg_env;
var arg_env_temp_val__2895 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__2895);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__2896 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__2896,"(");
...
var G__2897 = (i + (1));
var G__2898 = cljs.core.conj_BANG_.call(null,args,(function (){var or__5002__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__2894);
}});
/**
...
var ch = temp__5802__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__2899 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__2899);
...
var G__2900 = cljs.core.next.call(null,s__$1);
var G__2901 = ret;
s__$1 = G__2900;
r = G__2901;
continue;
...
var G__2903 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__2902;
key_vals = G__2903;
continue;
} else {
...
var gensym_env_orig_val__2906 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__2907 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__2907);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__2906);
}});
cljs.tools.reader.read_namespaced_map = (function cljs$tools$reader$read_namespaced_map(rdr,_,opts,pending_forms){
var vec__2908 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__2908,(0),null);
var start_column = cljs.core.nth.call(null,vec__2908,(1),null);
...
var temp__5802__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__2911 = token;
var G__2911__$1 = (((G__2911 == null))?null:cljs.core.subs.call(null,G__2911,(1)));
var G__2911__$2 = (((G__2911__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__2911__$1));
var G__2911__$3 = (((G__2911__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__2911__$2));
var G__2911__$4 = (((G__2911__$3 == null))?null:cljs.core.symbol.call(null,G__2911__$3));
if((G__2911__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__2911__$4);
}
})():(function (){var G__2912 = token;
var G__2912__$1 = (((G__2912 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__2912));
if((G__2912__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__2912__$1);
}
})()
));
if(cljs.core.truth_(temp__5802__auto__)){
...
var vec__2913 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__2913,(0),null);
var end_column = cljs.core.nth.call(null,vec__2913,(1),null);
...
}catch (e2922){if((e2922 instanceof Error)){
var e = e2922;
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__2926,reader){
var map__2927 = p__2926;
var map__2927__$1 = cljs.core.__destructure_map.call(null,map__2927);
var opts = map__2927__$1;
var eof = cljs.core.get.call(null,map__2927__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
