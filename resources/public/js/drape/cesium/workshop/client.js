...
return Cesium.defined(p1__26972_SHARP_.billboard);
});})(vals,kmlops,promise))
,vals);
var seq__26973 = cljs.core.seq.call(null,ebbs);
var chunk__26974 = null;
var count__26975 = (0);
var i__26976 = (0);
while(true){
if((i__26976 < count__26975)){
var ebb = cljs.core._nth.call(null,chunk__26974,i__26976);
...
var pos_26977 = ebb.position.getValue(Cesium.JulianDate.now());
var pos_26978__$1 = Cesium.Cartographic.fromCartesian(pos_26977);
var lat_26979 = Cesium.Math.toDegrees(pos_26978__$1.latitude);
var lon_26980 = Cesium.Math.toDegrees(pos_26978__$1.longitude);
var desc_26981 = ["<table class=\"cesium-infoBox-defaultTable cesium-infoBox-defaultTable-lighter\"><tbody>","<tr><th>Longitude</th><td>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(lon_26980.toFixed((5))),"</td></tr>","<tr><th>Latitude</th><td>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(lat_26979.toFixed((5))),"</td></tr>","</tbody></table>"].join('');
ebb.description = desc_26981;


var G__26982 = seq__26973;
var G__26983 = chunk__26974;
var G__26984 = count__26975;
var G__26985 = (i__26976 + (1));
seq__26973 = G__26982;
chunk__26974 = G__26983;
count__26975 = G__26984;
i__26976 = G__26985;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq.call(null,seq__26973);
if(temp__5735__auto__){
var seq__26973__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__26973__$1)){
var c__4461__auto__ = cljs.core.chunk_first.call(null,seq__26973__$1);
var G__26986 = cljs.core.chunk_rest.call(null,seq__26973__$1);
var G__26987 = c__4461__auto__;
var G__26988 = cljs.core.count.call(null,c__4461__auto__);
var G__26989 = (0);
seq__26973 = G__26986;
chunk__26974 = G__26987;
count__26975 = G__26988;
i__26976 = G__26989;
continue;
} else {
var ebb = cljs.core.first.call(null,seq__26973__$1);
ebb.billboard.verticalOrigin = Cesium.VerticalOrigin.BOTTOM;
...
var pos_26990 = ebb.position.getValue(Cesium.JulianDate.now());
var pos_26991__$1 = Cesium.Cartographic.fromCartesian(pos_26990);
var lat_26992 = Cesium.Math.toDegrees(pos_26991__$1.latitude);
var lon_26993 = Cesium.Math.toDegrees(pos_26991__$1.longitude);
var desc_26994 = ["<table class=\"cesium-infoBox-defaultTable cesium-infoBox-defaultTable-lighter\"><tbody>","<tr><th>Longitude</th><td>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(lon_26993.toFixed((5))),"</td></tr>","<tr><th>Latitude</th><td>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(lat_26992.toFixed((5))),"</td></tr>","</tbody></table>"].join('');
ebb.description = desc_26994;


var G__26995 = cljs.core.next.call(null,seq__26973__$1);
var G__26996 = null;
var G__26997 = (0);
var G__26998 = (0);
seq__26973 = G__26995;
chunk__26974 = G__26996;
count__26975 = G__26997;
i__26976 = G__26998;
continue;
}
} else {
...
return Cesium.defined(p1__26999_SHARP_.polygon);
});})(vals,promise))
,vals);
var seq__27000 = cljs.core.seq.call(null,epls);
var chunk__27001 = null;
var count__27002 = (0);
var i__27003 = (0);
while(true){
if((i__27003 < count__27002)){
var epl = cljs.core._nth.call(null,chunk__27001,i__27003);
...
var poss_27004 = epl.polygon.hierarchy.getValue(Cesium.JulianDate.now()).positions;
var cntr_27005 = Cesium.BoundingSphere.fromPoints(poss_27004).center;
var cntr_27006__$1 = Cesium.Ellipsoid.WGS84.scaleToGeodeticSurface(cntr_27005);
epl.position = cntr_27006__$1;
...
var G__27007 = seq__27000;
var G__27008 = chunk__27001;
var G__27009 = count__27002;
var G__27010 = (i__27003 + (1));
seq__27000 = G__27007;
chunk__27001 = G__27008;
count__27002 = G__27009;
i__27003 = G__27010;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq.call(null,seq__27000);
if(temp__5735__auto__){
var seq__27000__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__27000__$1)){
var c__4461__auto__ = cljs.core.chunk_first.call(null,seq__27000__$1);
var G__27011 = cljs.core.chunk_rest.call(null,seq__27000__$1);
var G__27012 = c__4461__auto__;
var G__27013 = cljs.core.count.call(null,c__4461__auto__);
var G__27014 = (0);
seq__27000 = G__27011;
chunk__27001 = G__27012;
count__27002 = G__27013;
i__27003 = G__27014;
continue;
} else {
var epl = cljs.core.first.call(null,seq__27000__$1);
epl.name = epl.properties.neighborhood;
...
var poss_27015 = epl.polygon.hierarchy.getValue(Cesium.JulianDate.now()).positions;
var cntr_27016 = Cesium.BoundingSphere.fromPoints(poss_27015).center;
var cntr_27017__$1 = Cesium.Ellipsoid.WGS84.scaleToGeodeticSurface(cntr_27016);
epl.position = cntr_27017__$1;
...
var G__27018 = cljs.core.next.call(null,seq__27000__$1);
var G__27019 = null;
var G__27020 = (0);
var G__27021 = (0);
seq__27000 = G__27018;
chunk__27001 = G__27019;
count__27002 = G__27020;
i__27003 = G__27021;
continue;
}
} else {
...
var expr__27023 = tile_sty.options.item(tile_sty.selectedIndex).value;
if(cljs.core.truth_(pred__27022.call(null,"none",expr__27023))){
return city.style = sty_default;
} else {
if(cljs.core.truth_(pred__27022.call(null,"height",expr__27023))){
return city.style = sty_height;
} else {
if(cljs.core.truth_(pred__27022.call(null,"transparent",expr__27023))){
