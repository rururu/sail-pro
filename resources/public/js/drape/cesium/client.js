...
var map__26940 = view;
var map__26940__$1 = (((((!((map__26940 == null))))?(((((map__26940.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__26940.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__26940):map__26940);
var longitude = cljs.core.get.call(null,map__26940__$1,new cljs.core.Keyword(null,"longitude","longitude",-1268876372));
var latitude = cljs.core.get.call(null,map__26940__$1,new cljs.core.Keyword(null,"latitude","latitude",394867543));
var height = cljs.core.get.call(null,map__26940__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var heading = cljs.core.get.call(null,map__26940__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var pitch = cljs.core.get.call(null,map__26940__$1,new cljs.core.Keyword(null,"pitch","pitch",1495126700));
var roll = cljs.core.get.call(null,map__26940__$1,new cljs.core.Keyword(null,"roll","roll",11266999));
...
cesium.client.VIEWER.homeButton.viewModel.command.beforeExecute.addEventListener(((function (map__26940,map__26940__$1,longitude,latitude,height,heading,pitch,roll,fvw){
return (function (e){
e.cancel = true;

return camera.flyTo(cesium.client.HOME_VIEW);
});})(map__26940,map__26940__$1,longitude,latitude,height,heading,pitch,roll,fvw))
);

return camera.flyTo(cesium.client.HOME_VIEW);
});
cesium.client.clock_settings = (function cesium$client$clock_settings(clock,settings,viewer){
var map__26942 = settings;
...
var animate = cljs.core.get.call(null,map__26942__$1,new cljs.core.Keyword(null,"animate","animate",1850194573));
var start = cljs.core.get.call(null,map__26942__$1,new cljs.core.Keyword(null,"start","start",-355208981));
var stop = cljs.core.get.call(null,map__26942__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
var current = cljs.core.get.call(null,map__26942__$1,new cljs.core.Keyword(null,"current","current",-1088038603));
var mult = cljs.core.get.call(null,map__26942__$1,new cljs.core.Keyword(null,"mult","mult",1466794774));
...
var promise = (function (){var pred__26944 = cljs.core._EQ_;
var expr__26945 = format;
if(cljs.core.truth_(pred__26944.call(null,new cljs.core.Keyword(null,"GeoJSON","GeoJSON",33508860),expr__26945))){
return Cesium.GeoJsonDataSource.load(source,options);
} else {
if(cljs.core.truth_(pred__26944.call(null,new cljs.core.Keyword(null,"CZML","CZML",-1539311408),expr__26945))){
return Cesium.CzmlDataSource.load(source,options);
} else {
if(cljs.core.truth_(pred__26944.call(null,new cljs.core.Keyword(null,"KML","KML",1829561453),expr__26945))){
return Cesium.KmlDataSource.load(source,options);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__26945)].join('')));
}
}
}
})();
...
cesium.client.azimuths_AMPERSAND_points = (function cesium$client$azimuths_AMPERSAND_points(p__26948,radr,hgt,N){
var vec__26949 = p__26948;
var c_lambda = cljs.core.nth.call(null,vec__26949,(0),null);
var c_phi = cljs.core.nth.call(null,vec__26949,(1),null);
var s = ((Math.PI * (2)) / N);
var azs = cljs.core.range.call(null,(0),(N * s),s);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [azs,cljs.core.vec.call(null,cljs.core.map.call(null,((function (s,azs,vec__26949,c_lambda,c_phi){
return (function (p1__26947_SHARP_){
return cljs.core.concat.call(null,cesium.client.position_js.call(null,c_lambda,c_phi,radr,p1__26947_SHARP_),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [hgt], null));
});})(s,azs,vec__26949,c_lambda,c_phi))
,azs))], null);
});
...
var vec__26952 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cmp__$1.longitude,cmp__$1.latitude,cmp__$1.height], null);
var lam = cljs.core.nth.call(null,vec__26952,(0),null);
var phi = cljs.core.nth.call(null,vec__26952,(1),null);
var hgt = cljs.core.nth.call(null,vec__26952,(2),null);
var az = camera.heading;
var c = ((((dist_m / (1852)) / (60)) / (180)) * Math.PI);
var vec__26955 = cesium.client.position_js.call(null,lam,phi,c,az);
var lam2 = cljs.core.nth.call(null,vec__26955,(0),null);
var phi2 = cljs.core.nth.call(null,vec__26955,(1),null);
...
var expr__26962 = cljs.core.deref.call(null,cesium.client.ORBIT).call(null,new cljs.core.Keyword(null,"status","status",-1997798413));
if(cljs.core.truth_(pred__26961.call(null,new cljs.core.Keyword(null,"init","init",-1875481434),expr__26962))){
...
if(cljs.core.truth_(pred__26961.call(null,new cljs.core.Keyword(null,"stop","stop",-2140911342),expr__26962))){
...
var vec__26964 = cesium.client.look_at.call(null,camera,radm);
var lam = cljs.core.nth.call(null,vec__26964,(0),null);
var phi = cljs.core.nth.call(null,vec__26964,(1),null);
var hgt = cljs.core.nth.call(null,vec__26964,(2),null);
var look = vec__26964;
var vec__26967 = cesium.client.azimuths_AMPERSAND_points.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [lam,phi], null),radr,hgt,steps);
var azs = cljs.core.nth.call(null,vec__26967,(0),null);
var pts = cljs.core.nth.call(null,vec__26967,(1),null);
var ring = cljs.core.vec.call(null,cljs.core.map.call(null,((function (steps,radm,radr,vec__26964,lam,phi,hgt,look,vec__26967,azs,pts,pred__26961,expr__26962,obut){
return (function (p1__26959_SHARP_){
return Cesium.Cartesian3.fromRadians(cljs.core.first.call(null,p1__26959_SHARP_),cljs.core.second.call(null,p1__26959_SHARP_),cljs.core.nth.call(null,p1__26959_SHARP_,(2)));
});})(steps,radm,radr,vec__26964,lam,phi,hgt,look,vec__26967,azs,pts,pred__26961,expr__26962,obut))
,pts));
var headings = cljs.core.vec.call(null,cljs.core.map.call(null,((function (steps,radm,radr,vec__26964,lam,phi,hgt,look,vec__26967,azs,pts,ring,pred__26961,expr__26962,obut){
return (function (p1__26960_SHARP_){
return cesium.client.normaz.call(null,(p1__26960_SHARP_ + Math.PI));
});})(steps,radm,radr,vec__26964,lam,phi,hgt,look,vec__26967,azs,pts,ring,pred__26961,expr__26962,obut))
,azs));
...
if(cljs.core.truth_(pred__26961.call(null,new cljs.core.Keyword(null,"run","run",-1821166653),expr__26962))){
camera.cancelFlight();
